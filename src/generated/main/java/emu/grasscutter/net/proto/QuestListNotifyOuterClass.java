...
public final class QuestListNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int QUEST_LIST_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < questList_.size(); i++) {
        output.writeMessage(9, questList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < questList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, questList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "QuestListNotify\022\032\n\nquest_list\030\t \003(\0132\006.Qu" +
