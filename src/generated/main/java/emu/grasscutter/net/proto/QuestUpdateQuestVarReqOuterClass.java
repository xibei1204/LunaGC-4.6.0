...
public final class QuestUpdateQuestVarReqOuterClass {
  ...
  public interface QuestUpdateQuestVarReqOrBuilder extends
     ...
     * </pre>
     *
     * <code>repeated .QuestVarOp quest_var_op_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int QUEST_VAR_OP_LIST_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < questVarOpList_.size(); i++) {
        output.writeMessage(3, questVarOpList_.get(i));
      }
      if (questId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < questVarOpList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, questVarOpList_.get(i));
      }
      if (questId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "uest_var_op_list\030\003 \003(\0132\013.QuestVarOp\022\034\n\024p" +
      "arent_quest_var_seq\030\014 \001(\r\022\020\n\010quest_id\030\004 " +
      "\001(\r\022\027\n\017parent_quest_id\030\010 \001(\rB\033\n\031emu.gras" +
    ...
    internal_static_QuestUpdateQuestVarReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_QuestUpdateQuestVarReq_descriptor,
        new java.lang.String[] { "QuestVarOpList", "ParentQuestVarSeq", "QuestId", "ParentQuestId", });
    emu.grasscutter.net.proto.QuestVarOpOuterClass.getDescriptor();
  }
